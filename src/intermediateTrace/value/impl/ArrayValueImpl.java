 ...
 * </p>
 * <ul>
 *   <li>{@link intermediateTrace.value.impl.ArrayValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayValueImpl extends ValueImpl implements ArrayValue {
	...
	protected EClass eStaticClass() {
		return ValuePackage.Literals.ARRAY_VALUE;
	}
	...
	public EList<Value> getValue() {
		if (value == null) {
			value = new EObjectContainmentEList<Value>(Value.class, this, ValuePackage.ARRAY_VALUE__VALUE);
		}
		return value;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ValuePackage.ARRAY_VALUE__VALUE:
