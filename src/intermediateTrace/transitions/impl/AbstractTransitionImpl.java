 ...
 * </p>
 * <ul>
 *   <li>{@link intermediateTrace.transitions.impl.AbstractTransitionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link intermediateTrace.transitions.impl.AbstractTransitionImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractTransitionImpl extends MinimalEObjectImpl.Container implements AbstractTransition {
	...
	public void setSource(State newSource) {
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject)source).eInverseRemove(this, IntermediateTracePackage.STATE__TRANSITION_TO, State.class, msgs);
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, IntermediateTracePackage.STATE__TRANSITION_TO, State.class, msgs);
	...
	public void setTarget(State newTarget) {
		if (newTarget != target) {
			NotificationChain msgs = null;
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, IntermediateTracePackage.STATE__TRANSITION_FROM, State.class, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, IntermediateTracePackage.STATE__TRANSITION_FROM, State.class, msgs);
