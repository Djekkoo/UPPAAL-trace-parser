/**
 */
package intermediateTrace.transitions.util;

import intermediateTrace.transitions.*;
 ...
 * <!-- end-user-doc -->
 * @see intermediateTrace.transitions.TransitionsPackage
 * @generated
 */
public class TransitionsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TransitionsPackage.ABSTRACT_TRANSITION: {
			...
			case TransitionsPackage.DELAY_TRANSITION: {
				DelayTransition delayTransition = (DelayTransition)theEObject;
				T result = caseDelayTransition(delayTransition);
				if (result == null) result = caseAbstractTransition(delayTransition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TransitionsPackage.EDGE_TRANSITION: {
				EdgeTransition edgeTransition = (EdgeTransition)theEObject;
				T result = caseEdgeTransition(edgeTransition);
				if (result == null) result = caseAbstractTransition(edgeTransition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Edge Transition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Edge Transition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEdgeTransition(EdgeTransition object) {
		return null;
	}
