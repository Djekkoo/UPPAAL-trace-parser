 ...
 * </p>
 * <ul>
 *   <li>{@link uppaal.expressions.FunctionCallExpression#getFunction <em>Function</em>}</li>
 *   <li>{@link uppaal.expressions.FunctionCallExpression#getArgument <em>Argument</em>}</li>
 * </ul>
 *
 * @see uppaal.expressions.ExpressionsPackage#getFunctionCallExpression()
...
public interface FunctionCallExpression extends Expression {
	 ...
	 * @see uppaal.expressions.ExpressionsPackage#getFunctionCallExpression_Function()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link uppaal.expressions.FunctionCallExpression#getFunction <em>Function</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uppaal.expressions.ExpressionsPackage#getFunctionCallExpression_Argument()
