...
import uppaal.core.impl.NamedElementImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link uppaal.templates.impl.LocationImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link uppaal.templates.impl.LocationImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link uppaal.templates.impl.LocationImpl#getColor <em>Color</em>}</li>
 *   <li>{@link uppaal.templates.impl.LocationImpl#getColorCode <em>Color Code</em>}</li>
 *   <li>{@link uppaal.templates.impl.LocationImpl#getParentTemplate <em>Parent Template</em>}</li>
 *   <li>{@link uppaal.templates.impl.LocationImpl#getInvariant <em>Invariant</em>}</li>
 *   <li>{@link uppaal.templates.impl.LocationImpl#getLocationTimeKind <em>Location Time Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
