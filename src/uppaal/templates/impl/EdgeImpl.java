...
import uppaal.visuals.ColorKind;
import uppaal.visuals.ColoredElement;
import uppaal.visuals.VisualsPackage;

import uppaal.visuals.impl.LinearElementImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link uppaal.templates.impl.EdgeImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link uppaal.templates.impl.EdgeImpl#getColor <em>Color</em>}</li>
 *   <li>{@link uppaal.templates.impl.EdgeImpl#getColorCode <em>Color Code</em>}</li>
 *   <li>{@link uppaal.templates.impl.EdgeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link uppaal.templates.impl.EdgeImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link uppaal.templates.impl.EdgeImpl#getParentTemplate <em>Parent Template</em>}</li>
 *   <li>{@link uppaal.templates.impl.EdgeImpl#getGuard <em>Guard</em>}</li>
 *   <li>{@link uppaal.templates.impl.EdgeImpl#getUpdate <em>Update</em>}</li>
 *   <li>{@link uppaal.templates.impl.EdgeImpl#getSynchronization <em>Synchronization</em>}</li>
 *   <li>{@link uppaal.templates.impl.EdgeImpl#getSelection <em>Selection</em>}</li>
 * </ul>
 *
 * @generated
 */
