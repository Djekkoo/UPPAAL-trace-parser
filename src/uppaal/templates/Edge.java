 ...
 * </p>
 * <ul>
 *   <li>{@link uppaal.templates.Edge#getSource <em>Source</em>}</li>
 *   <li>{@link uppaal.templates.Edge#getTarget <em>Target</em>}</li>
 *   <li>{@link uppaal.templates.Edge#getParentTemplate <em>Parent Template</em>}</li>
 *   <li>{@link uppaal.templates.Edge#getGuard <em>Guard</em>}</li>
 *   <li>{@link uppaal.templates.Edge#getUpdate <em>Update</em>}</li>
 *   <li>{@link uppaal.templates.Edge#getSynchronization <em>Synchronization</em>}</li>
 *   <li>{@link uppaal.templates.Edge#getSelection <em>Selection</em>}</li>
 * </ul>
 *
 * @see uppaal.templates.TemplatesPackage#getEdge()
...
public interface Edge extends LinearElement, CommentableElement, ColoredElement {
	 ...
	 * @see uppaal.templates.TemplatesPackage#getEdge_Source()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link uppaal.templates.Edge#getSource <em>Source</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uppaal.templates.TemplatesPackage#getEdge_Target()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link uppaal.templates.Edge#getTarget <em>Target</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link uppaal.templates.Template#getEdge <em>Edge</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see uppaal.templates.TemplatesPackage#getEdge_ParentTemplate()
	...
	/**
	 * Sets the value of the '{@link uppaal.templates.Edge#getParentTemplate <em>Parent Template</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uppaal.templates.TemplatesPackage#getEdge_Guard()
	...
	/**
	 * Sets the value of the '{@link uppaal.templates.Edge#getGuard <em>Guard</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uppaal.templates.TemplatesPackage#getEdge_Update()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see uppaal.templates.TemplatesPackage#getEdge_Synchronization()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link uppaal.templates.Edge#getSynchronization <em>Synchronization</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link uppaal.templates.Selection}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see uppaal.templates.TemplatesPackage#getEdge_Selection()
	 * @model containment="true"
	 * @generated
	 */
