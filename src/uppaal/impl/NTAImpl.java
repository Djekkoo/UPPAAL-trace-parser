 ...
 * </p>
 * <ul>
 *   <li>{@link uppaal.impl.NTAImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link uppaal.impl.NTAImpl#getGlobalDeclarations <em>Global Declarations</em>}</li>
 *   <li>{@link uppaal.impl.NTAImpl#getTemplate <em>Template</em>}</li>
 *   <li>{@link uppaal.impl.NTAImpl#getSystemDeclarations <em>System Declarations</em>}</li>
 *   <li>{@link uppaal.impl.NTAImpl#getInt <em>Int</em>}</li>
 *   <li>{@link uppaal.impl.NTAImpl#getBool <em>Bool</em>}</li>
 *   <li>{@link uppaal.impl.NTAImpl#getClock <em>Clock</em>}</li>
 *   <li>{@link uppaal.impl.NTAImpl#getChan <em>Chan</em>}</li>
 *   <li>{@link uppaal.impl.NTAImpl#getVoid <em>Void</em>}</li>
 * </ul>
 *
 * @generated
 */
