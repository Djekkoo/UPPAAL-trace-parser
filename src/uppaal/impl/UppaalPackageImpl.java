...
import uppaal.core.impl.CorePackageImpl;
import uppaal.declarations.DeclarationsPackage;

import uppaal.declarations.global.GlobalPackage;

import uppaal.declarations.global.impl.GlobalPackageImpl;

import uppaal.declarations.impl.DeclarationsPackageImpl;

import uppaal.declarations.system.SystemPackage;

import uppaal.declarations.system.impl.SystemPackageImpl;

import uppaal.expressions.ExpressionsPackage;

import uppaal.expressions.impl.ExpressionsPackageImpl;

import uppaal.statements.StatementsPackage;

import uppaal.statements.impl.StatementsPackageImpl;

import uppaal.templates.TemplatesPackage;

import uppaal.templates.impl.TemplatesPackageImpl;

import uppaal.types.TypesPackage;
import uppaal.types.impl.TypesPackageImpl;

import uppaal.util.UppaalValidator;

import uppaal.visuals.VisualsPackage;

import uppaal.visuals.impl.VisualsPackageImpl;
...
public class UppaalPackageImpl extends EPackageImpl implements UppaalPackage {
	 ...
	 * @see uppaal.UppaalPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(ntaEClass, uppaal.NTA.class, "NTA", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getNTA_GlobalDeclarations(), theDeclarationsPackage.getGlobalDeclarations(), null, "globalDeclarations", null, 0, 1, uppaal.NTA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNTA_Template(), theTemplatesPackage.getTemplate(), null, "template", null, 1, -1, uppaal.NTA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNTA_SystemDeclarations(), theDeclarationsPackage.getSystemDeclarations(), null, "systemDeclarations", null, 1, 1, uppaal.NTA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNTA_Int(), theTypesPackage.getPredefinedType(), null, "int", null, 1, 1, uppaal.NTA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNTA_Bool(), theTypesPackage.getPredefinedType(), null, "bool", null, 1, 1, uppaal.NTA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNTA_Clock(), theTypesPackage.getPredefinedType(), null, "clock", null, 1, 1, uppaal.NTA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNTA_Chan(), theTypesPackage.getPredefinedType(), null, "chan", null, 1, 1, uppaal.NTA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNTA_Void(), theTypesPackage.getPredefinedType(), null, "void", null, 1, 1, uppaal.NTA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
