 ...
 * </p>
 * <ul>
 *   <li>{@link uppaal.declarations.VariableContainer#getTypeDefinition <em>Type Definition</em>}</li>
 *   <li>{@link uppaal.declarations.VariableContainer#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @see uppaal.declarations.DeclarationsPackage#getVariableContainer()
 * @model abstract="true"
...
public interface VariableContainer extends EObject {
	 ...
	 * @see uppaal.declarations.DeclarationsPackage#getVariableContainer_TypeDefinition()
	...
	/**
	 * Sets the value of the '{@link uppaal.declarations.VariableContainer#getTypeDefinition <em>Type Definition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link uppaal.declarations.Variable}.
	 * It is bidirectional and its opposite is '{@link uppaal.declarations.Variable#getContainer <em>Container</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see uppaal.declarations.DeclarationsPackage#getVariableContainer_Variable()
