 ...
 * </p>
 * <ul>
 *   <li>{@link uppaal.declarations.TypeIndex#getTypeDefinition <em>Type Definition</em>}</li>
 * </ul>
 *
 * @see uppaal.declarations.DeclarationsPackage#getTypeIndex()
...
public interface TypeIndex extends Index {
	 ...
	 * @see uppaal.declarations.DeclarationsPackage#getTypeIndex_TypeDefinition()
	...
	/**
	 * Sets the value of the '{@link uppaal.declarations.TypeIndex#getTypeDefinition <em>Type Definition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
