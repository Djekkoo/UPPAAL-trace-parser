 ...
 * </p>
 * <ul>
 *   <li>{@link uppaal.types.Type#getIndex <em>Index</em>}</li>
 *   <li>{@link uppaal.types.Type#getBaseType <em>Base Type</em>}</li>
 *   <li>{@link uppaal.types.Type#getTypeSpecification <em>Type Specification</em>}</li>
 * </ul>
 *
 * @see uppaal.types.TypesPackage#getType()
 * @model abstract="true"
 * @generated
 */
public interface Type extends NamedElement {
	 ...
	 * @see uppaal.types.TypesPackage#getType_Index()
	 ...
	 * @see uppaal.types.TypesPackage#getType_BaseType()
	 ...
	 * @see uppaal.types.TypesPackage#getType_TypeSpecification()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
