 ...
 * </p>
 * <ul>
 *   <li>{@link uppaal.types.TypeDefinition#getBaseType <em>Base Type</em>}</li>
 *   <li>{@link uppaal.types.TypeDefinition#getTypeSpecification <em>Type Specification</em>}</li>
 * </ul>
 *
 * @see uppaal.types.TypesPackage#getTypeDefinition()
 * @model abstract="true"
 * @generated
 */
public interface TypeDefinition extends EObject {
	 ...
	 * @see uppaal.types.TypesPackage#getTypeDefinition_BaseType()
	 ...
	 * @see uppaal.types.TypesPackage#getTypeDefinition_TypeSpecification()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
