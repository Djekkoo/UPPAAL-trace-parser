 ...
 * </p>
 * <ul>
 *   <li>{@link uppaal.types.TypeReference#getReferredType <em>Referred Type</em>}</li>
 * </ul>
 *
 * @see uppaal.types.TypesPackage#getTypeReference()
 * @model
 * @generated
 */
public interface TypeReference extends TypeDefinition {
	 ...
	 * @see uppaal.types.TypesPackage#getTypeReference_ReferredType()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link uppaal.types.TypeReference#getReferredType <em>Referred Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
